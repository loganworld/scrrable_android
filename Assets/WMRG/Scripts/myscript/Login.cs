...
public class Login : MonoBehaviour
{
    ...
    IEnumerator iRequest(UnityWebRequest www)
    {
        ...
        else
        {
            if (mode == 0)
            {
                ...
                objNotification.transform.GetComponent<TextMeshProUGUI>().text = "Success!!!";
    ...
    public void OnClickSignUpButton()
    {
        ...
        {
            // objNotification.SetActive(true);
            objNotification.transform.GetComponent<TextMeshProUGUI>().text = "UserName or Password field was empty.";
            return;
        }
